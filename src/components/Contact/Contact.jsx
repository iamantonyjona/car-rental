...
const Contact = () => {
  return (
    <>
      ...
      <div data-aos="zoom-in" className="dark:bg-black dark:text-white py-14 sm:pb-24">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 bg-gray-800 py-8 px-6">
            <div className="col-span-2 space-y-3">
              ...
              <p className="text-gray-400">
                you can use various communication channels and methods. Here's a guide to clearly convey this information,{" "}
              </p>
            </div>
